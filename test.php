...
/*$contacts['request']['contacts']['add']=array(
	array(
					...
					'custom_fields'=>array(
					  array(
						#Телефоны
						'id'=>577052, #Уникальный индентификатор заполняемого дополнительного поля
						'values'=>array(
						  array(
							'value'=>'415.874.3275',
							'enum'=>'MOB' #Мобильный
    ...
    array(
        ...
        'text' => json_encode(
            array(
                ...
                'LINK' => 'http://example.com/file.zip', //прямая ссылка на запись звонка (optional)
                ...
                'call_result' => 'Получил', //результат (необязательно)
                'text' => 'ссылка на файл ',
                'service' => 'Файл:',
            )
        ),
