<?php
    ...
    echo "<h1>Authorization Info</h1>";
    #Массив с параметрами, которые нужно передать методом POST к API системы
    $user=array(
      'USER_LOGIN'=>'masterpola55@gmail.com', #Ваш логин (электронная почта)
    ...
    if(isset($Response['auth']))
    {
      ...
      //  echo 'Авторизация прошла успешно'."<br>";
            ...
            $link='https://'.$subdomain.'.amocrm.ru/private/api/v2/json/leads/list';
                ...
                $curl=curl_init(); #Сохраняем дескриптор сеанса cURL
                $link='https://'.$subdomain.'.amocrm.ru/private/api/v2/json/customers/list';
                ...
                echo "<h2>Notes</h2>";
                $link='https://'.$subdomain.'.amocrm.ru/private/api/v2/json/notes/list?type=contact';
                $curl=curl_init(); #Сохраняем дескриптор сеанса cURL
